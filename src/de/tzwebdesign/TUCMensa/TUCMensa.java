...
public class TUCMensa extends Activity implements OnGestureListener {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, 2, 0, R.string.SocialSend);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 2:
			...
			String mensa_help="rh";
			if (mensa == "st")
			mensa_help = "strana";
			sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT,
					"Ich esse jetzt Essen: "+attribute.getValue()+"! http://www-user.tu-chemnitz.de/~fnor/mensa/index.php?mensa="+mensa_help+" via #TUCMensa");
			startActivity(Intent.createChooser(sharingIntent, "*jamjam*"));
			return true;
		}
		return false;
	}
